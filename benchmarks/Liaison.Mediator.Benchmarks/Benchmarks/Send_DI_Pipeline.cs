...
public class Send_DI_Pipeline : BenchmarkBase
{
    ...
    public void Setup()
    {
        ...
        {
            liaisonServices.AddScoped<Liaison.Mediator.IPipelineBehavior<Ping, Pong>, PingPipeline>();
        }
        ...
        for (var i = 0; i < BehaviorCount; i++)
        {
            mediatRServices.AddScoped<MediatR.IPipelineBehavior<Ping, Pong>, PingPipeline>();
        }
